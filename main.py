...
OPRS = {'Регистрация претензии': '0', 'Проверка документов': '1', 'Поиск потерянной документации': '2', 'Урегулирование претензии': '4', 'Утверждение претензии': '5', 'Ремонт автомобиля': '6', 'Подготовка итоговой документации': '7', 'Закрытие страхового случая': '8', 'Обзор произошедшего случая': '9', 'Проверка на мошенничество': '12', 'Урегулирование объёма убытков': '58', 'Получение страховых резервов': '60', 'Отправка платежа': '61', 'Получение права на предъявление претензий от страхователя': '111', 'Отклонение претензии': '300', 'Предъявление апелляции по претензии': '343'}
OPRS_LETTERS = {}
